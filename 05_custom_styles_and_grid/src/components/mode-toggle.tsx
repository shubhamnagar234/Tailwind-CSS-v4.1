...
export const ModeToggle = () => {
  ...
  const SWITCH_THEME = () => {
    switch (theme) {
      ...
      case "systemTheme": {
        setSystemTheme(systemTheme === "light" ? "dark" : "light");
      }
    }
  };
  ...
  return (
    <button
      ...
      className="absolute size-8 border border-neutral-600 dark:border-neutral-800 rounded-md flex items-center justify-center top-4 right-4"
    >
