...
export const Hero = () => {
  return (
    <div className="my-40 flex w-full flex-col items-center justify-center">
      <h1 className="max-w-2xl bg-linear-to-b from-neutral-50 to-neutral-500 bg-clip-text text-center text-7xl leading-tight font-bold tracking-tight text-transparent font-victorMono">
        Unleash the power of intuitive finance
      </h1>
      <p className="mx-auto mt-10 max-w-3xl text-center text-xl text-neutral-500 selection:bg-white font-momoSignature">
      ...
      <div className="mt-12 flex w-full max-w-lg justify-center">
        <input
          type="text"
          className="mr-4 flex-1 rounded-xl border border-neutral-600 px-4 text-white placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-primary transition duration-200"
